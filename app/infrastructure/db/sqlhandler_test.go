...
func TestSQLHandler_where(t *testing.T) {
	...
	user3 := domain.User{
		...
		Name:             "hogefuga",
		MailAddress:      util.LiteralToPtrGenerics("test@test3.com"),
		PhoneNumber:      util.LiteralToPtrGenerics("09000000000"),
		Status:           domain.UserStatusActive,
		Role:             domain.UserRoleCommon,
		EmploymentStatus: domain.EmploymentStatusHourly,
	...
	user4 := domain.User{
		...
		Name:             "hogehoge",
		MailAddress:      util.LiteralToPtrGenerics("test@test4.com"),
		PhoneNumber:      util.LiteralToPtrGenerics("09000000000"),
		Status:           domain.UserStatusActive,
		Role:             domain.UserRoleCommon,
		EmploymentStatus: domain.EmploymentStatusHourly,
	...
	user5 := domain.User{
		...
		Name:             "fugafuga",
		MailAddress:      util.LiteralToPtrGenerics("test@test5.com"),
		PhoneNumber:      util.LiteralToPtrGenerics("09000000000"),
		Status:           domain.UserStatusActive,
		Role:             domain.UserRoleCommon,
		EmploymentStatus: domain.EmploymentStatusHourly,
	...
	user6 := domain.User{
		...
		MailAddress:      util.LiteralToPtrGenerics("test@test6.com"),
		PhoneNumber:      util.LiteralToPtrGenerics("09000000000"),
		Status:           domain.UserStatusActive,
		Role:             domain.UserRoleCommon,
		EmploymentStatus: domain.EmploymentStatusHourly,
